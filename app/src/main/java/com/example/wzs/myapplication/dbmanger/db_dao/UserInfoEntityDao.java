...
public class UserInfoEntityDao extends AbstractDao<UserInfoEntity, Long> {
    ...
    public static class Properties {
        ...
        public final static Property OnLine = new Property(10, String.class, "onLine", false, "ON_LINE");
    }
    ...
    public UserInfoEntity readEntity(Cursor cursor, int offset) {
        UserInfoEntity entity = new UserInfoEntity( //
            ...
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10) // onLine
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, UserInfoEntity entity, int offset) {
        ...
        entity.setOnLine(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
     }
