package com.example.wzs.myapplication.chat_ui;
...
/**
 * Created by hxcs-02 on 2017/8/25.
 */
...
public class ChatPrimaryMenu extends ChatPrimaryMenuBase implements View.OnClickListener {
    ...
    private void init(final Context context, AttributeSet attrs) {
      ...
      //  faceChecked = (ImageView) findViewById(R.id.iv_face_checked);
        ...
        edittext_layout.setBackgroundResource(R.drawable.text);
     ...
     */
    public void setPressToSpeakRecorderView(){
